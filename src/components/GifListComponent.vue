<template>
  ...
  >
    ...
    >
      <q-card
        class="p-0.5 hover:cursor-pointer hover:before:absolute hover:before:inset-0.5 hover:before:z-10 hover:before:bg-black hover:before:opacity-10 hover:before:content-['hello']"
      >
        <q-img
